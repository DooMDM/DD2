...
MIT applies to our source, not automatically to third-party components. See THIRD_PARTY.md and licenses/ for their separate terms. Private saves and native proprietary components are excluded from the source archive. See README_RU.md, TESTING.md and docs/FORMAT.md for details.
